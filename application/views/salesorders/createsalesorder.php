		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row mt-2">
						<div class="col-12">
							<textarea name="note" class="editortools" rows="10"></textarea>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	var currentRow = 2;
	var articles = {};
	var customerId = <?= !empty($this->uri->segment(3)) ? $this->uri->segment(3) : 'null' ?>;
	...
	function clickSuggestionList(row, index){
		...
		if (articles['priceagreements'][articles['products'][index]['ArticleNumber']] !== null) {
			$('[name="salesprice'+row+'"]').val(articles['priceagreements'][articles['products'][index]['ArticleNumber']]['Price']);
			$('[name="discount'+row+'"]').val(articles['priceagreements'][articles['products'][index]['ArticleNumber']]['Discount']);
		}
		else {
