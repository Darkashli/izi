	...
	<body>
		<div id="header">
			<div class="w50 inline">
				<img class="flleft" src="<?= base_url('assets/images/business/commpro/logo-cebonline.png'); ?>">
			</div>
		...
		<div id="footer">
			...
			<div class="ttop lh-1-3">CEB Online | Nijverheidsweg 6a | 3381 LM Giessenburg<br>
			t. 0184 - 65 41 27 | e. info@cebonline.nl | i. www.cebonline.nl</div>
		</div>
		<br>
		<br>
		<img class="bottom-logos" src="<?= base_url('assets/images/business/commpro/logos-ceb.svg') ?>">
		...
		<p class="l-h-7 m-0">CEB Online</p>
