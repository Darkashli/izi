...
<html>
    ...
    <body>
        ...
        <div id="header">
                <img class="flleft" src="<?= base_url('assets/images/business/jankorevaarhandel/logo.png') ?>">
                <img class="flright" src="<?= base_url('assets/images/business/jankorevaarhandel/slogan.svg'); ?>">
        </div>
