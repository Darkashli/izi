...
<html>
    ...
    <body>
        <div id="header">
            <table>
                <tr>
                    <td>Overzicht verkoopfacturen van periode van <?= $from; ?> tot en met <?= $to; ?></td>
                </tr>
            </table>
        </div>
            ...
            foreach ($invoices as $invoice) {
                ...
                <tr>
					<?php if ($customer != null): ?>
						<td colspan="4">Leverancier: <?= $customer->Name; ?>, <?= $customer->StreetName; ?>, <?= $customer->ZipCode; ?> <?= $customer->City; ?></td>
					<?php else: ?>
                ...
                <tr>
					<?php if ($customer != null): ?>
						<td colspan="4">BTW: <?= $customer->BTW; ?>, IBAN: <?= $customer->IBAN; ?>, KVK: <?= $customer->KVK; ?></td>
					<?php endif; ?>
                </tr>
                <tr>
                    <td colspan="2">Factuurdatum: <?= date('d-m-Y', $invoice->InvoiceDate); ?></td>
