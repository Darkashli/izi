...
<form method="post" action="<?= base_url(); ?>customers/<?= $this->uri->segment(2); ?>/<?= $this->uri->segment(3); ?>">
	<div class="row">
	...
	<div class="row justify-content-center">
		...
		<?php if ($this->uri->segment(2) == "updatecontact") { ?>
			<div class="col-md-4">
				<a href="<?= base_url(); ?>customers/deletecontact/<?= $this->uri->segment(3); ?>" class="btn btn-danger btn-block" id="removeRuleButton">Verwijderen</a>
			</div>
		<?php } ?>
	</div>
</form>
