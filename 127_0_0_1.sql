...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2019 at 10:56 AM
...
-- Database: `izi`
--
CREATE DATABASE IF NOT EXISTS `izi` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `izi`;
...
CREATE TABLE `business` (
  ...
  `OfferConfirmed` longblob DEFAULT NULL
...
INSERT INTO `quotation` (`Id`, `UserId`, `CreatorName`, `CustomerId`, `CustomerName`, `CustomerStreet`, `CustomerHousenumber`, `CustomerHousenumberAddition`, `CustomerZipCode`, `CustomerCity`, `CustomerCountry`, `CustomerMailaddress`, `CreatedDate`, `ContactId`, `ContactFirstName`, `ContactInsertion`, `ContactLastName`, `ContactSex`, `ContactSalutation`, `QuotationNumber`, `Subject`, `Reason`, `ContactDate`, `WorkDescription`, `WorkAmount`, `WorkArticleC`, `ProductDescription`, `RecurringDescription`, `RecurringTimePeriod`, `ProjectDescription`, `ValidDays`, `DeliveryTime`, `PaymentConditionId`, `PaymentTerm`, `IsComparison`, `Status`, `Confirmed`, `Rejected`, `Template`, `BusinessId`, `CurrentSituationAndAdvice`, `StatusPdf`, `Signature`, `Key`, `Notification`) VALUES
(149, 1, 'Alaa Darkashli', 1, 'Jacky valkparkietje ', 'Drossaartstraat ', '6', 'C', '4204AS', 'Gorinchem ', 'Nederland', 'alaa.darkashli@commpro.nl', '2019-12-04', 2, 'Alaa', '', 'Darkashli', 'male', 'informal', 'O2019-0203', 'Eerste offerte ', 'Dit is onze aanbieding voor deze maand', '2019-11-11', '', '0.00', '', '', '', '7 days', '', 15, '7', 1, 12, 0, 'sent', 0, 0, 'commpro', 1, '', NULL, 0x356465393064663139656233652e706e67, NULL, 0),
(150, 1, 'Alaa Darkashli', 1, 'Jacky valkparkietje ', 'Drossaartstraat ', '6', 'C', '4204AS', 'Gorinchem ', 'Nederland', 'alaa.darkashli@commpro.nl', '2019-11-11', 2, 'Alaa', '', 'Darkashli', 'male', 'informal', 'O2019-0204', 'Tweede offerte', 'Dit is onze aanbieding voor deze maand', '2019-11-11', '', '0.00', '', '', '', '7 days', '', 40, '7', 1, 2, 0, 'sent', 0, 0, 'commpro', 1, '', NULL, 0x356465376239313930343934622e706e67, '9550d794d4c601ff3f63c8237871b8ab', NULL);
...
('root', '{\"angular_direct\":\"direct\",\"snap_to_grid\":\"on\",\"relation_lines\":\"false\",\"full_screen\":\"on\",\"small_big_all\":\">\"}');
...
(1, 'root', 'database', 'izi_iteratie_5', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"structure_or_data_forced\":\"0\",\"table_select[]\":[\"attachments\",\"business\",\"ci_sessions\",\"contactmoment\",\"contacts\",\"contactss\",\"customers\",\"defaulttexts\",\"domain\",\"importtype\",\"invoice\",\"invoicecustomfield\",\"invoicepayments\",\"invoicereminders\",\"invoicerules\",\"invoicerulessupplier\",\"invoicesupplier\",\"invoicesupplierpayments\",\"migrations\",\"natureofwork\",\"notificationmessage\",\"paymentconditions\",\"priceagreement\",\"product\",\"productgroup\",\"productimage\",\"project\",\"projectphase\",\"purchaseorderrules\",\"purchaseorders\",\"quotation\",\"quotationcustomfield\",\"quotationfile\",\"quotationrules\",\"quotationstatus\",\"reasons\",\"repeatinginvoice\",\"salesordercustomfield\",\"salesorderrules\",\"salesorders\",\"seller\",\"status\",\"supplier\",\"systemmanagementgroup\",\"systemmanagementhardware\",\"systemmanagementinternetdata\",\"systemmanagementlogonscript\",\"systemmanagementnetworkinformation\",\"systemmanagementshare\",\"systemmanagementsoftware\",\"systemmanagementuser\",\"ticket\",\"ticketproduct\",\"ticketrules\",\"transporter\",\"transporter_import\",\"user\",\"warehouse\",\"webshop\",\"website\",\"woocommerceorderimports\",\"year\"],\"table_structure[]\":[\"attachments\",\"business\",\"ci_sessions\",\"contactmoment\",\"contacts\",\"contactss\",\"customers\",\"defaulttexts\",\"domain\",\"importtype\",\"invoice\",\"invoicecustomfield\",\"invoicepayments\",\"invoicereminders\",\"invoicerules\",\"invoicerulessupplier\",\"invoicesupplier\",\"invoicesupplierpayments\",\"migrations\",\"natureofwork\",\"notificationmessage\",\"paymentconditions\",\"priceagreement\",\"product\",\"productgroup\",\"productimage\",\"project\",\"projectphase\",\"purchaseorderrules\",\"purchaseorders\",\"quotation\",\"quotationcustomfield\",\"quotationfile\",\"quotationrules\",\"quotationstatus\",\"reasons\",\"repeatinginvoice\",\"salesordercustomfield\",\"salesorderrules\",\"salesorders\",\"seller\",\"status\",\"supplier\",\"systemmanagementgroup\",\"systemmanagementhardware\",\"systemmanagementinternetdata\",\"systemmanagementlogonscript\",\"systemmanagementnetworkinformation\",\"systemmanagementshare\",\"systemmanagementsoftware\",\"systemmanagementuser\",\"ticket\",\"ticketproduct\",\"ticketrules\",\"transporter\",\"transporter_import\",\"user\",\"warehouse\",\"webshop\",\"website\",\"woocommerceorderimports\",\"year\"],\"table_data[]\":[\"attachments\",\"business\",\"ci_sessions\",\"contactmoment\",\"contacts\",\"contactss\",\"customers\",\"defaulttexts\",\"domain\",\"importtype\",\"invoice\",\"invoicecustomfield\",\"invoicepayments\",\"invoicereminders\",\"invoicerules\",\"invoicerulessupplier\",\"invoicesupplier\",\"invoicesupplierpayments\",\"migrations\",\"natureofwork\",\"notificationmessage\",\"paymentconditions\",\"priceagreement\",\"product\",\"productgroup\",\"productimage\",\"project\",\"projectphase\",\"purchaseorderrules\",\"purchaseorders\",\"quotation\",\"quotationcustomfield\",\"quotationfile\",\"quotationrules\",\"quotationstatus\",\"reasons\",\"repeatinginvoice\",\"salesordercustomfield\",\"salesorderrules\",\"salesorders\",\"seller\",\"status\",\"supplier\",\"systemmanagementgroup\",\"systemmanagementhardware\",\"systemmanagementinternetdata\",\"systemmanagementlogonscript\",\"systemmanagementnetworkinformation\",\"systemmanagementshare\",\"systemmanagementsoftware\",\"systemmanagementuser\",\"ticket\",\"ticketproduct\",\"ticketrules\",\"transporter\",\"transporter_import\",\"user\",\"warehouse\",\"webshop\",\"website\",\"woocommerceorderimports\",\"year\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@DATABASE@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"structure_and_data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"structure_and_data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_procedure_function\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"xml_structure_or_data\":\"data\",\"xml_export_events\":\"something\",\"xml_export_functions\":\"something\",\"xml_export_procedures\":\"something\",\"xml_export_tables\":\"something\",\"xml_export_triggers\":\"something\",\"xml_export_views\":\"something\",\"xml_export_contents\":\"something\",\"yaml_structure_or_data\":\"data\",\"\":null,\"lock_tables\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_create_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"izi\",\"table\":\"quotation\"},{\"db\":\"izi\",\"table\":\"notificationmessage\"},{\"db\":\"izi\",\"table\":\"user\"},{\"db\":\"izi\",\"table\":\"business\"},{\"db\":\"izi\",\"table\":\"quotationfile\"},{\"db\":\"izi\",\"table\":\"ticketrules\"},{\"db\":\"izi\",\"table\":\"ticket\"},{\"db\":\"izi\",\"table\":\"customers\"},{\"db\":\"izi\",\"table\":\"product\"},{\"db\":\"izi\",\"table\":\"QuotationFile\"}]');
...
('izi', 'business', 1, 770, 30),
('izi', 'quotation', 1, 310, 30);
...
('root', 'izi', 'quotation', '{\"sorted_col\":\"`Id` DESC\"}', '2019-12-05 14:49:11');
...
('root', '2019-12-06 09:33:50', '{\"Console\\/Mode\":\"collapse\",\"FontSize\":\"85%\",\"Console\\/Height\":165,\"NavigationWidth\":274}');
...
INSERT INTO `tbl_messages` (`id`, `user_id`, `message`, `status`) VALUES
(1, 3, 'This is the first message ', 1),
(2, 4, 'This is the first message ', 2),
(3, 3, 'This is the second message ', 1),
(4, 4, 'This is the second message ', 2);
...
INSERT INTO `tbl_users` (`id`, `name`, `mail`, `phone`, `salary`) VALUES
(3, 'John', 'john@hotmail.com', '444444', '1800'),
(4, 'jacky', 'jacky@hotmail.com', '33333', '1900'),
(5, 'Tim', 'jacky@hotmail.com', '33333', '1850'),
(6, 'Jan', 'jacky@hotmail.com', '33333', '1900');
...
--
ALTER TABLE `tbl_messages`
  ADD CONSTRAINT `tbl_messages_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_users` (`id`);
--
-- Database: `tutorial_2`
--
CREATE DATABASE IF NOT EXISTS `tutorial_2` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `tutorial_2`;
COMMIT;
